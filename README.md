...
| `L` | Cycle the info panel's **grouping layout** — titled sections → spaced (blank lines) → flat — or click the **Layout** radio at the bottom of the panel. A **maximized** info pane always shows titled sections. Persisted |
