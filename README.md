...
- **Repo page tabs** — `off` keeps the repo page as one scrolling list; `auto` splits it into **Branches / Worktrees / Stashes tabs** when at least two of those sections have rows (switch with `Tab`/`Shift+Tab` or click a tab chip).
