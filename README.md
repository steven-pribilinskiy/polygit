...
- **Dock repo page** — show the repo page as a **docked bottom panel** (the two panes stay visible above it) instead of full-screen. Toggle with `b`, the `b dock` footer hint, or this setting; persisted.
