...
fn build_action_defs() -> Vec<ActionDef> {
    ...
    action_defs![
        ...
        (CycleResultView,     "cycle_result_view",   "Cycle diff sub-display (log/raw/unified/split)", "Panes & views", List, (C('d'), false, false, false), &["d"]),
        (CycleResultCategory, "cycle_result_category", "Cycle result category tab",     "Panes & views", List, (C('D'), false, false, false), &["D"]),
        // List — pull / retry
        ...
        (OpenDocs,            "open_docs",           "Open the docs website",           "App & modals", Global, (C('d'), true, false, false), &["ctrl+d"]),
